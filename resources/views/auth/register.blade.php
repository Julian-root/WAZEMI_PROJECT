<div class="register-box">
  <div class="card card-outline card-primary" style="margin-top: 20px;">
    ...
    <div class="card-body" >
      <p class="login-box-msg text-dark bg-gray-light pt-3" style="border-radius: 8px 8px 0 0; font-size: 1.3em;"><b>Rejoindre notre communauté</b></p>
...
<!-- <div wire:ignore.self>
    ...
    @if($currentPage == PAGELIST)
      @include("auth.formulaires.makechoice")
    @endif
  
    @if($currentPage == PAGEEDITFORM)
      @include("auth.formulaires.form_client")
    @endif 

    @if($currentPage == PAGECREATEFORM)
    @include("auth.formulaires.form_conducteur")
  @endif 
</div> -->
