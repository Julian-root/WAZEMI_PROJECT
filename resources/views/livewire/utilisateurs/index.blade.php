          ...
          <table class="table table-head-fixed text-nowrap">
            <thead>
              <tr>
                ...
                <th style="width: 20%;" class="text-center">Ajoué</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <button class="btn btn-link" wire:click.prevent="goToEditUser('{{$user->id }}')"><i
                      class="far fa-edit"></i></button>
                  <button class="btn btn-link" wire:click.prevent="confirmDelete('{{ $user->id }}')"><i
...
@include("livewire.utilisateurs.alert")
